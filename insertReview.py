...
for i in range (1000):
    query = "insert into REVIEW (STUDENT_ID, DEVICE_ID, R_TIME, OPINION, RATE) values ({}, {}, convert(datetime2, '{}'), '{}', {})".format(random.choice(students_id), random.choice(device_id), startT, ''.join(random.choice(string.ascii_uppercase + string.digits) for _ in range(4)), 4)
